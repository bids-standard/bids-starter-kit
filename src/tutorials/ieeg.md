...
-   `<raw-data-filename>_ieeg.json`: contains the metadata that are the same for
    ...
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/templates/sub-01/ses-01/ieeg/sub-01_ses-01_task-LongExample_run-01_ieeg.json)
    or find the Matlab script to more automatically populate the required fields
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/ieeg/createBIDS_ieeg_json.m).
-   `<raw-data-filename>_channels.tsv`: The TSV file contains all the settings
    ...
    bids-starter-kit
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/templates/sub-01/ses-01/ieeg/sub-01_ses-01_task-LongExample_run-01_channels.tsv)
    or find the Matlab script to more automatically populate the required fields
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/ieeg/createBIDS_ieeg_channels_tsv.m).
...
-   `_electrodes.tsv`: Download a template in the bids-starter-kit
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/templates/sub-01/ses-01/ieeg/sub-01_ses-01_electrodes.tsv)
    or find the Matlab script to more automatically populate the required fields
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/ieeg/createBIDS_ieeg_electrodes_tsv.m).
-   `_coordsystem.json`: Download a template in the bids-starter-kit
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/templates/sub-01/ses-01/ieeg/sub-01_ses-01_coordsystem.json)
    or find the Matlab script to more automatically populate the required fields
    [here](https://github.com/bids-standard/BIDS-Starter-Kit/matlabCode/ieeg/createBIDS_ieeg_coordsystem_json.m).
